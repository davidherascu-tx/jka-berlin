      ...
      <div className="mx-auto max-w-7xl px-6 lg:px-10 py-16 lg:py-20">
        <div className="grid gap-12 md:grid-cols-2 lg:grid-cols-3">
          <div>
            ...
            {/* Social icons + JKA Japan link side by side */}
            <div className="mt-6 flex items-center gap-5">
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="group inline-flex flex-col gap-0.5 border-l-2 border-red-600 pl-3"
              >
                <span lang="ja" className="text-sm tracking-[0.2em] text-white">
                  {"日 本 空 手 協 会"}
                </span>
                <span className="text-[10px] font-bold tracking-[0.2em] uppercase text-red-500 group-hover:text-red-400 transition-colors">

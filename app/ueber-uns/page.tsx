...
export const metadata: Metadata = {
  title: "Über uns",
  description:
    "Das Honbu-Dojo Leiden-kan - Geschichte, Philosophie und Karate-Do der Japan Karate Association in Berlin.",
};
  ...
  return (
    <>
      <PageHero
        ...
        title="Über uns"
        subtitle="Karate-Dō im Stil der Japan Karate Association – Tradition trifft Berlin."
